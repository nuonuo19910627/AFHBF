...
Page({
  ...
  formSubmit: function (e) {
   ...
   // util.showBusy('请求中...')
    qcloud.request({
      url: `${config.service.host}/weapp/makeaddress`,
      login: false,
      data: {
        uid: openid,
        F_NAME: adds.name,
        ...
        // city: this.data.city,
        // quyu: this.data.area,
        F_ADDRESS: adds.address,
        F_DEFAULT: that.data.code,
      },
      success(res) {
        /*
        ...
        wx.redirectTo({
          url: 'user-address/user-address?cartId=' + that.data.cartId + '&count_id=' + that.data.count_id
        });
      },
      fail(error) {
